...
import ... tbd ... // TODO Please specify package name.MESASIMCLEquipmentBeatFilter;
 ...
 */
public class MESGeneratedASIMCLEquipmentBeat extends MESATObject //nl
                                                 implements IMESGeneratedASIMCLEquipmentBeat {


    /** Generated column name */
    public static final String COL_NAME_CYCLETIME = "cycletime";
     ...
     */
    public MESGeneratedASIMCLEquipmentBeat(long key) {
        super(key);
    }
     ...
     */
    public MESGeneratedASIMCLEquipmentBeat(MESGeneratedASIMCLEquipmentBeat source) {
        super(source);
    }
     ...
     */
    public MESGeneratedASIMCLEquipmentBeat(ATRow baseATRow) {
        super(baseATRow);
    }
     ...
     */
    public MESGeneratedASIMCLEquipmentBeat() {
        super();
    }
     ...
     */
    public static MESASIMCLEquipmentBeatFilter createFilter(Server server) {
        return new MESASIMCLEquipmentBeatFilter(server);
    }
     ...
     * @return the filter object
     */
    public static MESASIMCLEquipmentBeatFilter createFilter() {
        return new MESASIMCLEquipmentBeatFilter();
    }
     ...
     */
    public static List<IMESASIMCLEquipmentBeat> getFilteredObjects(MESASIMCLEquipmentBeatFilter filter) {
        return MESATObject.getFilteredMESATObjectList(filter, MESASIMCLEquipmentBeat.class);
    }
    ...
    public String getCycletime() {
        return (String) this.dgtATRow.getValue(COL_NAME_CYCLETIME);
    }

    @Override
    public void setCycletime(String value) {
        String oldValue = this.getCycletime();
        this.dgtATRow.setValue(COL_NAME_CYCLETIME, value);
        pcs.firePropertyChange(PROP_NAME_CYCLETIME, oldValue, value);
    }
